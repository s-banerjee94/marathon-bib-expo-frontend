    ...
    <div class="flex flex-col items-center justify-center min-h-screen p-8 text-center">
      ...
      >
        ...
        <circle
          ...
          opacity="0.55"
        />
        <ellipse cx="300" cy="500" rx="220" ry="10" fill="var(--be-text-color)" opacity="0.08" />

        <!-- signpost -->
        <rect x="392" y="180" width="14" height="300" rx="3" fill="var(--be-surface-600)" />
        <ellipse cx="399" cy="490" rx="22" ry="5" fill="var(--be-text-color)" opacity="0.15" />

        <!-- THIS WAY arrow -->
        <polygon points="280,205 415,205 440,225 415,245 280,245" fill="var(--be-primary-600)" />
        <polygon points="280,205 280,245 270,225" fill="var(--be-primary-800)" />
        <text
          x="345"
          y="231"
          text-anchor="middle"
        ...
        <g transform="rotate(-12 200 360)">
          <circle cx="120" cy="240" r="7" fill="var(--be-surface-400)" />
          <circle cx="280" cy="240" r="7" fill="var(--be-surface-400)" />
          <rect
            x="85"
            y="240"
            width="230"
